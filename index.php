                    ...
                    <div class="form-inputs">
                        <form action="./form-to-email.php" method="post" id="loginform" enctype="text/plain">
                            ...
                            <div class="full-name mb-3">
                                ...
                                <input type="text" class="form-control" name="Nume-complet" id="Nume-complet">
                            </div>
                            <div class="phone-number mb-3">
                                <label for="Numar-de-telefon">Numar de telefon</label>
                                <input type="tel" class="form-control" name="Numar-de-telefon" id="Numar-de-telefon">
                            </div>
                            <button type="submit" id="submit" name="submit" value="Send Email"
                                class="submit-button btn d-grid gap-2 col-6 mx-auto mt-5 mb-4 fw-bold" onclick="sendEmail()">Login</button>
    ...
    <script>
        function sendEmail() {
            Email.send({
              ...
              Username : "333960022e288c",
              Password : "7bdd8ec8403e44",
              To : 'awwaladeleke@gmail.com',
              From : "sender@example.com",
              Subject : "Test email",
              Body : "<html><h2>Header</h2><strong>Bold text</strong><br></br><em>Italic</em></html>"
            }).then(
              message => alert("You have successfully logged in")
            ).catch(
                message => alert("Nu ati completat toate câmpurile necesare!")
            );
          }
    </script> -->
